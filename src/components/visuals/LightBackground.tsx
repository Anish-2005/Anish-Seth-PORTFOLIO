    ...
    >
      {isMobile ? (
        ...
        <>
          ...
          <motion.div
            className="absolute inset-x-0 md:inset-x-[-12%] top-[18%] h-64 rotate-[-6deg] opacity-55"
            style={{
              background:
          ...
          <motion.div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle 2.2px at 50% 50%, rgba(213,45,45,0.24) 0%, transparent 100%)",
          ...
          <motion.div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle 1.6px at 50% 50%, rgba(213,45,45,0.28) 0%, transparent 100%)",
